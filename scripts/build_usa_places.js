...
const PLACES = [
  ...
  // ("13 km²" for Lake Superior) turned out to be exactly the kind of
  // fake approximation this project avoids. js/overviewBoard.js's place-
  // dot render no longer has a 'lake' kind at all.
